...
function Details({name, about1}: userType) {
    const [btnClick, setBtnClikc] = useState([false, false, false, false]);
    ...
    return (
        <div className="w-64 h-[80vh] hidden lg:flex flex-col justify-between">
            ...
            <div className="buttons flex flex-row items-center justify-center gap-2 py-3 border-t-[1px] border-gray-400">
