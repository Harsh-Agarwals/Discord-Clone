    ...
    return (
        <div className="relative flex flex-row justify-between gap-2 items-center py-3 px-2 border-t-[1px] border-gray-400">
            ...
            <div className=" relative">
                ...
                <input ref={inputRef} type="text" name="sendMsg" id="sendMsg" className=" text-sm px-2 ps-8 py-1 rounded-md outline-none bg-slate-800 border-[1px] border-gray-500 text-gray-300 w-64 tracking-wider " placeholder="Type a message..." value={text} onChange={(e) => textChange(e.target.value)} />
            </div>
            <div>
